...
\begin{proof}
  ...
  \begin{equation}\label{equation:product-expansion}
    \begin{aligned}
      ...
      & + n^n \mathlarger{\sum}_{j = 1}^{2^k - 1}
...
\begin{proof}[Proof of Theorem 1]
  ...
  \begin{equation*}
    \begin{aligned}
      \nu_N
        & = \nu^{(1)}_N \\
        & + \sum_{s = k}^{r - 1} \left[ t(s) \left( s^s |I| + s^{s - 1} (2^k - 1) \varepsilon_s \right) \right] + \varepsilon_{\nu^{(2)}_N} \\
        & + q \left( r^r |I| + r^{r - 1} (2^k - 1) \varepsilon_r \right)  + \varepsilon_{\nu^{(3)}_N} \\
        & + \nu^{(4)}_N + \varepsilon_b
    \end{aligned}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{aligned}
      \nu_N
        ...
        & + \nu^{(1)}_N \\
        & + \sum_{s = k}^{r - 1} \left[ t(s) s^{s - 1} (2^k - 1) \varepsilon_s \right] + \varepsilon_{\nu^{(2)}_N} \\
        & + q r^{r - 1} (2^k - 1) \varepsilon_r  + \varepsilon_{\nu^{(3)}_N} \\
        & + \nu^{(4)}_N + \varepsilon_b
    \end{aligned}
  \end{equation*}
  ...
  and after dividing both sides by $|I|$ and rearranging terms we obtain:
  ...
  we can see that for large values of $r$:
