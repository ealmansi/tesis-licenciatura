...
We provide an alternative proof of Theorem 1 based on Weyl's Criterion, as stated in section \ref{section:weyls-criterion}, and using a proposition from the theory of linear modular congruences and a well-known fact from the study of the roots of unity.
